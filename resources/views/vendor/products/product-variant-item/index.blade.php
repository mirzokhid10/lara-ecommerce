      ...
      <div class="row">
        <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
          ...
          <div class="dashboard_content mt-2 mt-md-0">
            ...
            <div class="create_button my-3">
                <a href="{{route('vendor.product-variant-item.create', ['productId' => $product->id, 'variantId' => $variant->id])}}" class="btn btn-primary"><i class="fas fa-plus"></i> Create Variant Item</a>
            </div>
